...
<div class="titles">
	<p><fmt:message key="title.product.manage"/></p>
</div>

  <div class="container">
   <label for="productid"><b><fmt:message key="label.product.id"/></b></label>
    <input type="text" 
    	placeholder="<fmt:message key="label.product.id"/>" 
    	name="productid"
    	id ="productid"
    	value="${sessionScope.producttoedit.id}" readonly
    ...
    <input type="text" 
    	...
    	name="producttitle"
    	value="${sessionScope.producttoedit.title}"
    ...
    <input type="text" 
    	...
    	name="productsummary"
    	value="${sessionScope.producttoedit.summary}"
		required pattern="^[a-zA-Z0-9 \-&]+$"
    	required="required">
    ...
    <input type="text" 
    	...
    	value="${sessionScope.producttoedit.quantity}"
    ...
    <input type="text" 
    	...
    	name="productprice"
    	value="${sessionScope.producttoedit.price}"
		required pattern="^[0-9\.]+$"
    	required="required">	
    ...
    <br><label for="productbrand"><b><fmt:message key="label.product.brand"/></b></label>
	    ...
	    <option selected value="${sessionScope.producttoedit.brand}">${sessionScope.producttoedit.brand}</option>
	 ...
	 <br><label for="productForm"><b><fmt:message key="label.product.form"/></b></label>   
	    ...
	    <option selected value="${sessionScope.producttoedit.form}">${sessionScope.producttoedit.form}</option>
	  ...
	  <br><label for="productbreed"><b><fmt:message key="label.product.breed"/></b></label>   
	    ...
	    <option selected value="${sessionScope.producttoedit.breed}">${sessionScope.producttoedit.breed}</option>
	   ...
	   <option selected value="${sessionScope.producttoedit.ageRate}">${sessionScope.producttoedit.ageRate}</option>
	   ...
	   <option selected value="${sessionScope.producttoedit.animalType}">${sessionScope.producttoedit.animalType}</option>
	   ...
	   <option selected value="${sessionScope.producttoedit.weight}">${sessionScope.producttoedit.weight}</option>
    ...
    <c:set var="action" value="passtoupdate" scope="session"/>
    <c:set var="fillForm" value="" scope="session"/>
  </div>
